...
describe('Service Tests', () => {
  describe('Carro Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(CarroService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Carro(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Carro', () => {
        ...
        service.create(new Carro()).subscribe(resp => (expectedResult = resp.body));
